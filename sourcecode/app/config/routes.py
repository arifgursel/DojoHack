...
routes['POST']['/processreg'] = 'Auths#process_reg'
routes['POST']['/processlog'] = 'Auths#process_log'
#Project Routes
routes['/postauth'] = 'Projectnames#index'
routes['GET']['/project/new'] = 'Projectnames#new'
routes['POST']['/project'] = 'Projectnames#create'
routes['GET']['/project/<int:id>'] = 'Projectnames#show'
routes['GET']['/project/<int:id>/edit'] = 'Projectnames#edit'
routes['PATCH']['/project/<int:id>'] = 'Projectnames#update'
routes['DELETE']['/project/<int:id>'] = 'Projectnames#delete'
"""
